...
namespace PLAYLIST
{
    public partial class PlaylistListWindow : Window
    {
        ...
        private void OpenPlaylistButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(selectedPlaylistName))
            {
                MessageBox.Show("Please select a playlist to open.", "Warning", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }

            // Suponiendo que MainWindow acepta el nombre de la playlist como parámetro en su constructor
            var mainWindow = new MainWindow(selectedPlaylistName);
            mainWindow.Show();
        }
        ...
        private void OpenPlaylistButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                PlaylistOpened?.Invoke(this, selectedPlaylist);
            }
            else
            {
